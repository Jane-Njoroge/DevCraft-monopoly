...
CREATE TABLE public.players (
    ...
    chance text,
    chest text,
    amount numeric(10,2) DEFAULT 1500.00 NOT NULL
);
...
COPY public.game (id, date, active, created, room, chance, chest) FROM stdin;
\.
...
COPY public.players (id, property, chance, chest, amount) FROM stdin;
\.
...
1	admin	admin.monopoly@gmail.com	monopoly123
\.
